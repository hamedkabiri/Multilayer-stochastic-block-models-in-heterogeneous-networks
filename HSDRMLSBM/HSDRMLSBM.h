                 ...
                 if (NeighborLayers[ l] == 1)
                 {
                    ...
                    for (i=0 ; i<ActualDiffComms[l] ; i++)
                    {
                           ...
                           if (NeighborSet[l ][0 ][i] == destination)
                               ...
                               help += double(Degree[vertex ][l])/(LL[fromLayer][l]+LL[l][fromLayer]);
                 ...
                 if (NeighborLayers[ fromLayer] == 1)
                 {
                    ...
                    for (i=0 ; i<ActualDiffComms[fromLayer] ; i++)
                    {
                           ...
                           if (NeighborSet[fromLayer ][0 ][i] == destination)
                               ...
                               help += double(Degree[vertex ][fromLayer])/(LL[fromLayer][fromLayer]);
             ...
             for (p=0 ; p<MaxComms ; p++)
             {
                       ...
                       //cout<<"kabiri11"<<endl;
                         ...
                         ratiovalue = ratiovalue + (LogFunction((help1 + help2) ) - LogFunction((help1) )) ;
                          ...
                          help1 = double(CurrentCommStubsNew[ azz]);
                             
                         ratiovalue = ratiovalue - 2*LogFunction((help1 - help) ) + 2*LogFunction(help1 );
                         help1 = double(CurrentCommStubsNew[destination]);
