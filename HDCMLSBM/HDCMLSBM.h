            ...
            for(l=m; l < Layers; l++)
               ...
               if (LL[m][l]!=0 && LL[l][m]!=0 )
                  for(i=0; i < MaxComms; i++)
                  {
                         ...
                         if (DegreeCorrect == 1)
                             if(m!=l)
                                sum = sum - 2*LogFunction(double(BestCommStubs[m][l][i]+BestCommStubs[l][m][i])/(LL[m][l]+LL[l][m]));
                             else
                         ...
                         for(j=0; j < MaxComms; j++)
                                  {
                                   if(m!=l)
                                     sum = sum + LogFunction(double(BestEdgeMatrix[m][l][i][j]+BestEdgeMatrix[l][m][i][j])/(LL[m][l]+LL[m][l]));
                                   else
                                       sum = sum + LogFunction(double(BestEdgeMatrix[m][l][i][j])/(LL[m][l]));
                                  }
                  }                          
                 ...
                 if (NeighborLayers[ l] == 1)
                 {
                    ...
                    for (i=0 ; i<ActualDiffComms[l] ; i++)
                    {
                           ...
                           if ((NeighborSet[ l ] [0 ][ i] != azz) && (NeighborSet[ l][0 ][i] != destination))
                           {
                                ...
                                //cout<<"kabiri1"<<endl;
                                ratiovalue = ratiovalue + (LogFunction((help1-help3)/(LL[fromLayer][l]+LL[l][fromLayer])) - LogFunction(help1/(LL[fromLayer][l]+LL[l][fromLayer]) ));
                                ratiovalue = ratiovalue + (LogFunction((help2+help3)/(LL[fromLayer][l]+LL[l][fromLayer])) - LogFunction(help2/(LL[fromLayer][l]+LL[l][fromLayer]) ));
                        ...
                        ratiovalue = ratiovalue + (LogFunction((help1 + help2)/(LL[fromLayer][l]+LL[l][fromLayer])) - LogFunction(help1/(LL[fromLayer][l]+LL[l][fromLayer]) ));
                 ...
                 if (NeighborLayers[ fromLayer] == 1)
                 {
                    ...
                    for (i=0 ; i<ActualDiffComms[fromLayer] ; i++)
                    {
                           ...
                           if ((NeighborSet[ fromLayer ] [0 ][ i] != azz) && (NeighborSet[ fromLayer][0 ][i] != destination))
                           {
                              ...
                              help1 = double(CurrentEdgeMatrix[fromLayer][fromLayer][azz][int(NeighborSet[fromLayer][0][i])]);
                              help2 = double(CurrentEdgeMatrix[fromLayer][fromLayer][destination][int(NeighborSet[fromLayer][0][i])]);
                              help3 = double(NeighborSet[fromLayer][1][i]);
                              

                              ratiovalue = ratiovalue + LogFunction((help1 - help3)/(LL[fromLayer][fromLayer])) - LogFunction(help1/(LL[fromLayer][fromLayer]));
                              ratiovalue = ratiovalue + LogFunction((help2 + help3)/(LL[fromLayer][fromLayer]) )- LogFunction(help2/(LL[fromLayer][fromLayer]));
                              
                              help1 = double(CurrentEdgeMatrix[fromLayer][fromLayer][int(NeighborSet[fromLayer][0][i])][azz]);
                              help2 = double(CurrentEdgeMatrix[fromLayer][fromLayer][int(NeighborSet[fromLayer][0][i])][destination]);
                              help3 = double(NeighborSet[fromLayer][1][i]);
                           ...
                           if (NeighborSet[fromLayer ][0 ][i] == azz)
                                  ...
                                  fromcount = NeighborSet[fromLayer ][1 ][i];

                           if (NeighborSet[fromLayer ][0 ][i] == destination)

                                  destcount = NeighborSet[fromLayer ][1 ][i];
                    }
                        ...
                        //cout<<"kabiri3"<<endl;
                         help1 = double(CurrentEdgeMatrix[fromLayer ][fromLayer ][azz ][destination]);
                         help2 = double(fromcount - destcount);
                         ratiovalue = ratiovalue + LogFunction((help1 + help2)/(LL[fromLayer][fromLayer]) ) - LogFunction(help1/(LL[fromLayer][fromLayer]) );
                        ...
                        //cout<<"kabiri3"<<endl;
                         help1 = double(CurrentEdgeMatrix[fromLayer ][fromLayer ][destination][azz ]);
                         help2 = double(fromcount - destcount);
                         ratiovalue = ratiovalue + LogFunction((help1 + help2)/(LL[fromLayer][fromLayer]) ) - LogFunction(help1/(LL[fromLayer][fromLayer]) );
                        ...
                        //cout<<"kabiri7"<<endl;
                         help1 = double(CurrentEdgeMatrix[fromLayer ][fromLayer ][azz ][azz]);
                        ...
                        //cout<<"kabiri11"<<endl;
                         help1 = double(CurrentEdgeMatrix[fromLayer ][fromLayer ][destination ][destination]);
