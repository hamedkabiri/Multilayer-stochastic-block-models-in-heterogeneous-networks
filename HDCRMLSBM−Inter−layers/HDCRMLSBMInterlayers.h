...
double JointEntropy();
double Apply_method_Restricted2();
  ...
  //  for (p=0 ; p<Layers ; p++)
     ...
     //}
       ...
       long deg = 0;
                 ...
                 if (NeighborLayers[ fromLayer] == 1)
                 {
                    ...
                    for (i=0 ; i<ActualDiffComms[fromLayer] ; i++)
                    {
                           ...
                           if ((NeighborSet[ fromLayer ] [0 ][ i] != azz) && (NeighborSet[ fromLayer][0 ][i] != destination))
                           {
                              ...
                              help33 = double(NeighborSet[fromLayer][1][i]);
                              

                              ratiovalue = ratiovalue + LogFunction((help1 - help33)/(LL[fromLayer][fromLayer])) - LogFunction(help1/(LL[fromLayer][fromLayer]));
                              ratiovalue = ratiovalue + LogFunction((help2 + help33)/(LL[fromLayer][fromLayer]) )- LogFunction(help2/(LL[fromLayer][fromLayer]));
        ...
        destcount = 0;
        for(l=0 ; l < Layers; l++)
             if (LL[fromLayer][l] != 0 && fromLayer!=l)
